...
import com.gt.produits.entities.Categorie;
...
class ProduitsApplicationTests {
	...
	@Test
	 public void testCreateProduit() {
		Produit prod = new Produit("PC Lenovo",2200.500,new Date(System.currentTimeMillis()));
	...
	{
	List<Produit> prods =
	produitRepository.findByCategorieIdCat(2L);
	for (Produit p : prods)
	{
	System.out.println(p);
	}
